...
export default async function Objetivos3ccPage() {
  ...
  const objByKey = new Map(s.objetivos_colab.map(o => [`${o.colaborador_id}|${o.tipo}|${o.ramo}`, Number(o.valor)]));
  ...
  return (
    <div className="space-y-6">
      ...
      <ObjetivosForm3cc colaboradores={colabs} ramosPart={ramosPart} ramosEmp={ramosEmp} objByKey={Object.fromEntries(objByKey)}/>
    </div>
  );
}
