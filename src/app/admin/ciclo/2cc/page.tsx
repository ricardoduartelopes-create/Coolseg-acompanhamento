  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Link href="/admin/ciclo/2cc/sync-crafteer" className="bg-white rounded-xl shadow p-5 hover:shadow-md transition border-2 border-head/20">
        ...
        <Link href="/admin/ciclo/2cc/import" className="bg-white rounded-xl shadow p-5 hover:shadow-md transition">
        ...
        <Link href="/admin/ciclo/2cc/import-div" className="bg-white rounded-xl shadow p-5 hover:shadow-md transition">
        ...
        <Link href="/admin/ciclo/2cc/apolices" className="bg-white rounded-xl shadow p-5 hover:shadow-md transition">
        ...
        <Link href="/admin/ciclo/2cc/objetivos" className="bg-white rounded-xl shadow p-5 hover:shadow-md transition">
        ...
        <Link href="/admin/ciclo/2cc/ramos" className="bg-white rounded-xl shadow p-5 hover:shadow-md transition">
        ...
        <Link href="/admin/ciclo/2cc/lista" className="bg-white rounded-xl shadow p-5 hover:shadow-md transition">
        ...
        <Link href="/admin/ciclo/2cc/sprint-ps" className="bg-white rounded-xl shadow p-5 hover:shadow-md transition border-2 border-head/20">
